 ...
 * <ul>
 *   <li>{@link ee.xtext.haxe.haxe.impl.ArrayLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayLiteralImpl extends ExpressionImpl implements ArrayLiteral
{
  ...
  {
    return HaxePackage.Literals.ARRAY_LITERAL;
  }
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, HaxePackage.ARRAY_LITERAL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HaxePackage.ARRAY_LITERAL__ELEMENTS:
