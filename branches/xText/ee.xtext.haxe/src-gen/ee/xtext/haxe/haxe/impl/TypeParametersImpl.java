 ...
 * <ul>
 *   <li>{@link ee.xtext.haxe.haxe.impl.TypeParametersImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeParametersImpl extends MinimalEObjectImpl.Container implements TypeParameters
{
  ...
  {
    return HaxePackage.Literals.TYPE_PARAMETERS;
  }
  ...
  public EList<TypeParameter> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<TypeParameter>(TypeParameter.class, this, HaxePackage.TYPE_PARAMETERS__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HaxePackage.TYPE_PARAMETERS__PARAMETERS:
