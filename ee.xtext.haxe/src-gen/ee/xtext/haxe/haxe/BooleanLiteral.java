 ...
 * <ul>
 *   <li>{@link ee.xtext.haxe.haxe.BooleanLiteral#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @see ee.xtext.haxe.haxe.HaxePackage#getBooleanLiteral()
 * @model
 * @generated
 */
public interface BooleanLiteral extends Expression
{
   ...
   * @see ee.xtext.haxe.haxe.HaxePackage#getBooleanLiteral_IsTrue()
   * @model
   * @generated
   */
  boolean isIsTrue();
  ...
  /**
   * Sets the value of the '{@link ee.xtext.haxe.haxe.BooleanLiteral#isIsTrue <em>Is True</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
