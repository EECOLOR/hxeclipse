 ...
 * <ul>
 *   <li>{@link ee.xtext.haxe.haxe.VariableDeclaration#getName <em>Name</em>}</li>
...
public interface VariableDeclaration extends Feature
{
   ...
   * @see #setName(String)
   * @see ee.xtext.haxe.haxe.HaxePackage#getVariableDeclaration_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link ee.xtext.haxe.haxe.VariableDeclaration#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
