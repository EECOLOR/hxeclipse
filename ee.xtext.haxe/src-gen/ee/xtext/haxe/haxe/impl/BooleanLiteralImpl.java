 ...
 * <ul>
 *   <li>{@link ee.xtext.haxe.haxe.impl.BooleanLiteralImpl#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralImpl extends ExpressionImpl implements BooleanLiteral
{
  ...
  {
    return HaxePackage.Literals.BOOLEAN_LITERAL;
  }
  ...
  public void setIsTrue(boolean newIsTrue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HaxePackage.BOOLEAN_LITERAL__IS_TRUE, oldIsTrue, isTrue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HaxePackage.BOOLEAN_LITERAL__IS_TRUE:
        return isIsTrue();
    }
