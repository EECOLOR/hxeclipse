 ...
 * <ul>
 *   <li>{@link ee.xtext.haxe.haxe.impl.FunctionExpressionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link ee.xtext.haxe.haxe.impl.FunctionExpressionImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link ee.xtext.haxe.haxe.impl.FunctionExpressionImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionExpressionImpl extends ExpressionImpl implements FunctionExpression
{
  ...
  {
    return HaxePackage.Literals.FUNCTION_EXPRESSION;
  }
  ...
  public NotificationChain basicSetBody(Expression newBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HaxePackage.FUNCTION_EXPRESSION__BODY, oldBody, newBody);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setBody(Expression newBody)
  {
    if (newBody != body)
    {
      NotificationChain msgs = null;
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HaxePackage.FUNCTION_EXPRESSION__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HaxePackage.FUNCTION_EXPRESSION__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HaxePackage.FUNCTION_EXPRESSION__BODY, newBody, newBody));
  }
